...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        String summary = getFriendlyDateString(mContext, mCursor.getLong(INDEX_WEATHER_DATE), false) + " - "
                + getStringForWeatherCondition(mContext, mCursor.getInt(INDEX_WEATHER_CONDITION_ID)) + " - "
                + formatHighLows(mContext, mCursor.getDouble(INDEX_WEATHER_MAX_TEMP), mCursor.getDouble(INDEX_WEATHER_MIN_TEMP));
